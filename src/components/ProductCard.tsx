        ...
        <div className="absolute top-3 left-3 z-10 flex flex-col gap-2">
          {product.badge && !isSale && (
            <motion.span 
              ...
              className="inline-block bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-dark)] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg"
            >
              {product.badge}
            </motion.span>
          )}
