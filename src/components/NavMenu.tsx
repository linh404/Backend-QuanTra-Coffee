      ...
      {menuItems.map((item) => (
        ...
        >
          {item.children ? (
            <>
              <button
                className="text-gray-700 hover:text-[var(--color-primary)] hover:bg-[var(--color-primary-50)] px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center space-x-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2"
